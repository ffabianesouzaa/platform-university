...
def list_campi_ocup(campi):
    ...
    rows = db.execute('''
        ...
        UNION SELECT Ocupação FROM NaoOcupadas WHERE Cidade = ?
        AND (Janeiro2022 > 0 OR Fevereiro2022 > 0 OR Março2022 > 0 OR Abril2022 > 0
        OR Maio2022 > 0 OR Junho2022 > 0 OR Julho2022 > 0 OR Agosto2022 > 0 OR Setembro2022 > 0
        OR Outubro2022 > 0 OR Novembro2022 > 0 OR Dezembro2022 > 0) 
    ...
    ocupadas = db.execute('''
        SELECT SUM(Janeiro2022 + Fevereiro2022 + Março2022 + Abril2022 + Junho2022 +
    ...
    nocupadas = db.execute('''
        SELECT SUM(Janeiro2022 + Fevereiro2022 + Março2022 + Abril2022 + Junho2022 + Julho2022 +
        Agosto2022 + Setembro2022 + Outubro2022 + Novembro2022 + Dezembro2022)
        FROM NaoOcupadas WHERE Cidade = ? 
    ''', (campi,)).fetchall()
    ...
    topOcupadas = db.execute('''
        SELECT Ocupação, (Janeiro2022 + Fevereiro2022 + Março2022 + Abril2022 + Junho2022 + Julho2022 +
...
def list_campi_ocup(campi, ocupacoes):
    ...
    nocupadas = db.execute('''
        SELECT SUM(Janeiro2022 + Fevereiro2022 + Março2022 + Abril2022 + Junho2022 + Julho2022 +
        Agosto2022 + Setembro2022 + Outubro2022 + Novembro2022 + Dezembro2022)
        FROM NaoOcupadas WHERE Cidade = ? AND Ocupação = ?
    ''', (campi, ocupacoes)).fetchall()
